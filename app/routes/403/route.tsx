    ...
    <>
      ...
      <main className="my-40 flex w-full justify-center px-4 sm:px-10">
        <Link
          to="/"
          className={cx(
            "relative px-10 text-8xl font-bold text-blue-900 decoration-wavy underline-offset-2  hover:text-blue-700 hover:underline focus:text-blue-700 focus:underline",
